...
public class ApiClient {
    private static final String BASE_URL = "https://rentbnb-0wbk.onrender.com/api/v1/"; // http://10.0.2.2:3000/api/v1/ is localhost for Android emulator | https://rentbnb-0wbk.onrender.com/api/v1/ for Render  http://10.0.2.2:3000/api/v1/
